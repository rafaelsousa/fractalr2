...
public class TransformationPanel extends Group  {
	...
	public ActionButton [] botoes;
    public ImageView [] iconesBotoes;
    public Integer incrementoY=26;
    public Integer posicao = quantidadeTransformacoes;
    private Boolean ultimo=true;
    private Integer posY=(incrementoY*posicao)+44;
   ...
   var contornoAreaDeBotoes:Rectangle =Rectangle {
	...
	//trata a adição da um botão na barra de formulas
	...
	//trata a adição da um botão na barra de fórmulas
