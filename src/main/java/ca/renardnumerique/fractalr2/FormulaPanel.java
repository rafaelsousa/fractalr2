...
public class FormulaPanel extends Group {
    ...
    private void drawBoundaries() {
        ...
        area.setWidth(660);
        area.setHeight(33);
        LinearGradient linearFill = new LinearGradient(0, 0.5, 0, 1.5, Boolean.TRUE, CycleMethod.NO_CYCLE,
                new Stop(0.0, Color.web("#FFF")), new Stop(1.0, Color.web("#AAA")));
        ...
        LinearGradient linearGradient = new LinearGradient(0, 0.7, 0, 1.5, Boolean.TRUE, CycleMethod.NO_CYCLE,
                new Stop(0.0, Color.web("#FFFAC1")), new Stop(1.0, Color.web("#AAA")));
    ...
    public void trataArrastar(DragDrop btn) {
        transformationPanel.getChildren().remove(ActionButton.BOTAO_SEPARADOR);
    ...
    public void setFormula(Text formula) {
        this.formula = formula;
    }

    public Rectangle getContornoAreaDeBotoes() {
        return this.contornoAreaDeBotoes;
    }

    public void setContornoAreaDeBotoes(Rectangle contornoAreaDeBotoes) {
        this.contornoAreaDeBotoes = contornoAreaDeBotoes;
    }

    public Group getAreaDeBotoes() {
        return this.areaDeBotoes;
    }

    public void setAreaDeBotoes(Group areaDeBotoes) {
        this.areaDeBotoes = areaDeBotoes;
    }
}
