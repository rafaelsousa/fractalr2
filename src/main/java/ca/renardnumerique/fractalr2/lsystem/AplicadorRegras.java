...
//
//	public static Integer iteracao;
//	public List<ActionButton> botoesFormula;
//
//	public static List<Comando> pilhaComandos;
//	static List<AcaoLSystem> pilhaAcoes;
//
//public static void gerarComandos() {
